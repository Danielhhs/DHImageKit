...
NSString *const kDHImageWarmthFragmentShaderString = SHADER_STRING
(
 ...
 void main()
{
    ...
    gl_FragColor = vec4(mix(source.rgb, mix(rgb, processed, temperature), strength), source.a);
}
 );
@implementation DHImageWarmthFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kDHImageWarmthFragmentShaderString]))
    {
        return nil;
    }
