...
NSString *const kDHImageFourInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation DHImageFourInputFilter

#pragma mark - Initialization and teardown

- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString
{
    if (!(self = [self initWithVertexShaderFromString:kDHImageFourInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
