...
NSString *const kDHImageThreeInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation DHImageThreeInputFilter
#pragma mark -
#pragma mark Initialization and teardown

- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    if (!(self = [self initWithVertexShaderFromString:kDHImageThreeInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
