...
#import "DHImagePerlinNoiseFilter.h"
NSString *const kDHImagePerlinNoiseFragmentShaderString = SHADER_STRING
(
...
@implementation DHImagePerlinNoiseFilter
 - (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kDHImagePerlinNoiseFragmentShaderString]))
    {
        return nil;
    }
