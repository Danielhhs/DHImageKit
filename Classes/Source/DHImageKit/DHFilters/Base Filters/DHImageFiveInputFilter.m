...
NSString *const kDHImageFiveInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation DHImageFiveInputFilter
#pragma mark - Initialization and teardown

- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString
{
    if (!(self = [self initWithVertexShaderFromString:kDHImageFiveInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
