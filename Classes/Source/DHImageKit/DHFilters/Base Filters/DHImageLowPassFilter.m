...
@implementation DHImageLowPassFilter
...
- (id)init;
{
    ...
    dissolveBlendFilter = [[DHImageDissolveBlendFilter alloc] init];
    [self addFilter:dissolveBlendFilter];
    
    // Buffer the result to be fed back into the blend
    bufferFilter = [[DHImageBuffer alloc] init];
