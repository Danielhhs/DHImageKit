...
NSString *const kDHImageSixInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation DHImageSixInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kDHImageSixInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
