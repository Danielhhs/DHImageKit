...
NSString *const kDHImageLevelsFragmentShaderString = SHADER_STRING
(
 ...
 void main()
 {
     ...
     gl_FragColor = vec4(mix(textureColor.rgb, LevelsControl(textureColor.rgb, levelMinimum, levelMiddle, levelMaximum, minOutput, maxOutput), strength), textureColor.a);
 }
 );


@implementation DHImageLevelsFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kDHImageLevelsFragmentShaderString]))
    {
        return nil;
    }
