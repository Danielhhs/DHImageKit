...
- (id)init
{
    self = [super   initWithFragmentShaderFromString:kIFEarlybirdShaderString
                                             sources:@[
                                                       [IFImageFilter filterImageNamed:@"earlyBirdCurves"],
                                                       [IFImageFilter filterImageNamed:@"earlybirdOverlayMap"],
                                                       [IFImageFilter filterImageNamed:@"vignetteMap"],
                                                       [IFImageFilter filterImageNamed:@"earlybirdBlowout"],
                                                       [IFImageFilter filterImageNamed:@"earlybirdMap"],
                                                       ]];
    return self;
}
